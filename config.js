...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '2_11_ade8_1b13_6391').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,wiptech',
  ...
  PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || 'Hello',
